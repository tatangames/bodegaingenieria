...
<div id="divcontenedor" style="display: none">
    ...
    <section class="content-header">
        <div class="row">
            <h1 style="margin-left: 5px">Encargados de Proyecto</h1>
        </div>
        <br>
        <div class="row">
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var ruta = "{{ URL::to('/admin/encargados/tabla') }}";
    ...
    <script>
        ...
        function recargar(){
            var ruta = "{{ url('/admin/encargados/tabla') }}";
            $('#tablaDatatable').load(ruta);
        }
        ...
        function nuevoRegistro(){
            ...
            axios.post(url+'/encargados/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id){
            ...
            axios.post(url+'/encargados/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post(url+'/encargados/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
