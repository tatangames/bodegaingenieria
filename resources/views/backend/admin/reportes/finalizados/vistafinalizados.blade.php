            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="callout callout-info">
                        <h5 style="font-weight: bold"><i class="fas fa-info"></i> Generar Reporte de Proyectos Finalizados</h5>
                        <div class="card">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="info-box shadow">
                                                <div class="info-box-content">
                                                    <label>Lista de Proyectos (FINALIZADOS)</label>
...
@section('archivos-js')
    ...
    <script>
        ...
        function generarPdf() {
            ...
            window.open("{{ URL::to('admin/reporte/pdf/finalizados') }}/" + idpro);
        }
