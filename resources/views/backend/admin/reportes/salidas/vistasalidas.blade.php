            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="callout callout-info">
                        <h5 style="font-weight: bold"><i class="fas fa-info"></i> Generar Reporte de Salidas</h5>
                        <div class="card">
...
@section('archivos-js')
    ...
    <script>
        ...
        function generarPdf() {
            ...
            var idrecibe = document.getElementById('select-recibe').value;

            if(idpro === ''){
                return
            }

            window.open("{{ URL::to('admin/reporte/pdf/salidas') }}/" + idpro + "/" + idrecibe);
        }
