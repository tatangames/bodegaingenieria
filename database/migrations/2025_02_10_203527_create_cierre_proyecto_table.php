...
class CreateCierreProyectoTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('cierre_proyecto', function (Blueprint $table) {
            ...
            $table->bigInteger('id_entrega_proyecto')->unsigned(); // PROYECTOS ENTREGA
            $table->bigInteger('id_recibe_proyecto')->unsigned(); // PROYECTOS RECIBE
            ...
            $table->foreign('id_entrega_proyecto')->references('id')->on('tipoproyecto');
            $table->foreign('id_recibe_proyecto')->references('id')->on('tipoproyecto');
